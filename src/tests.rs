...
fn de() {
    let xs = &[
        2.1612279832241123e-9,
        -5.555700866607811e-9,
        1.9210579073988262e-8,
        -6.188761066759264e-9,
    ];
...
fn pso() {
    let xs = &[
        1.3505824954659202e-8,
        5.276212482179906e-10,
        -8.399554179326833e-9,
        -1.9561557749055913e-8,
    ];
